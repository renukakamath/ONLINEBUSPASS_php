      ...
      <th>To Place</th>
       ...
       <td><?php echo $row['fp'] ?></td>
          <td><?php echo $row['tp'] ?></td>
           ...
           <td><a class="btn btn-success" href="mybookings.php?bid=<?php echo $row['booking_child_id'] ?>">Download</a></td>
    <td><a class="btn btn-success" href="user_cancelticket.php?bid=<?php echo $row['booking_child_id'] ?>">Cancel Ticket</a></td> 
